    ...
    <div className="flex relative w-full items-center gap-4 shadow-md rounded-lg p-4 mb-4 border border-gray-600">
      ...
      <div className='relative'>
        ...
        <div className="flex mt-4">
          <Link href={`/recipe/edit-recipe/${recipe._id}`} className="text-gray-300 mr-7 bg-gray-700 p-2 rounded-lg">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:scale-105 transition-all duration-150">
