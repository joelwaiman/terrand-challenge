...
export default function Navigation() {
  ...
  return (
    <nav className="sticky bg-[rgba(34,40,49,0.8)] p-4 top-0 left-0 right-0 z-10 border-b border-gray-600">
      <div className="container mx-auto flex flex-col md:flex-row gap-4 justify-between items-center w-full">
        {isLoggedIn ?
          <>
          ...
          <div className='flex flex-col md:flex-row gap-4 justify-between items-center w-full'>
            ...
            <div className="flex gap-4 text-center items-center">
              ...
              <Link
                href="/register"
                className="bg-[#c5ab6b] hover:bg-[#ad9558] text-white font-bold py-2 px-4 rounded"
              >
                Registrarse
              </Link>
            </div>
